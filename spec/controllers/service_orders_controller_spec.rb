...
RSpec.describe ServiceOrdersController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all service_orders as @service_orders" do
      service_order = ServiceOrder.create! valid_attributes
      get :index, {}, valid_session
      expect(assigns(:service_orders)).to eq([service_order])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested service_order as @service_order" do
      service_order = ServiceOrder.create! valid_attributes
      get :show, {:id => service_order.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested service_order as @service_order" do
      service_order = ServiceOrder.create! valid_attributes
      get :edit, {:id => service_order.to_param}, valid_session
      expect(assigns(:service_order)).to eq(service_order)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new ServiceOrder" do
        expect {
          post :create, {:service_order => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved service_order as @service_order" do
        post :create, {:service_order => invalid_attributes}, valid_session
        expect(assigns(:service_order)).to be_a_new(ServiceOrder)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested service_order" do
        service_order = ServiceOrder.create! valid_attributes
        put :update, {:id => service_order.to_param, :service_order => new_attributes}, valid_session
      ...
      it "assigns the requested service_order as @service_order" do
        service_order = ServiceOrder.create! valid_attributes
        put :update, {:id => service_order.to_param, :service_order => valid_attributes}, valid_session
        expect(assigns(:service_order)).to eq(service_order)
      end
    ...
    describe "with invalid params" do
      it "assigns the service_order as @service_order" do
        service_order = ServiceOrder.create! valid_attributes
        put :update, {:id => service_order.to_param, :service_order => invalid_attributes}, valid_session
        expect(assigns(:service_order)).to eq(service_order)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested service_order" do
      service_order = ServiceOrder.create! valid_attributes
      expect {
        delete :destroy, {:id => service_order.to_param}, valid_session
      }.to change(ServiceOrder, :count).by(-1)
    end
